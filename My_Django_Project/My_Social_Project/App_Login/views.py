...
def sign_up(request):
    ...
    return render(request, 'App_Login/singup.html', context={'title':'singup Form Here', 'form':form})
...
def profile(request):
    ...
    return render(request, 'App_Login/user.html', context={'title':'User Profile Page','form':form})
